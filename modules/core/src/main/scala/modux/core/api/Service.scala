...
trait Service extends CallDirectives with RegisterDSL with MethodDSL with ResponseExtensions with FutureImplicits with ContextSupport with SchemaSupport with MacwireSupport