...
object Deps {
	...
	//************** VERSIONS **************//
	private final val macwireVersion: String = "2.5.6"
	private final val akkaVersion: String = "2.6.19"
	private final val akkaHTTPVersion: String = "10.2.9"
	private final val scalaLoggingVersion: String = "3.9.4"
	private final val xbeanVersion: String = "4.20"
	private final val ansiInterpolatorVersion: String = "1.1.0"
	private final val self4jVersion: String = "1.7.36"
	private final val jacksonVersion: String = "2.13.2"
	private final val typeConfigVersion: String = "1.4.2"
	private final val logbackClassicVersion: String = "1.2.11"
	private final val kryoSerializationVersion: String = "2.4.3"
	...
	private final val compressVersion: String = "1.21"
	private final val akkaKafkaVersion: String = "2.1.1"
	private final val akkaCorsVersion: String = "1.1.3"
	private final val caffeineVersion: String = "3.0.6"
	private final val twirlVersion: String = "1.5.1"
	private final val pac4jVersion: String = "4.5.6"
	...
	//************** GRAPHQL **************//
	lazy val graphql = "io.github.joacovela16" %% "graphql4s" % "0.1.3"
	//************** UTILS **************//
	...
	lazy val jsonSmart = "net.minidev" % "json-smart" % "2.4.8"
